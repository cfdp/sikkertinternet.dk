 ...
 */
function safer_pixie_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['safer_pixie_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('safer_pixie sample setting'),
  '#default_value' => theme_get_setting('safer_pixie_example'),
